...
#define  button_delay 120 //Задержка срабатывания нажатых кнопок, настройки "Часов" и "Минут". Величина в "попугаях", зависит от срабатывания прерывания ТС0
#define  number_TCNT0 225 //Число задает начальное значение регистра TCNT
